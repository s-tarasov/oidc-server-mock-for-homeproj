    ...
    public class Startup
    {
      ...
      new DataProtectorShim(
          ...
          .CreateProtector(
            ...
            var authPaths = new[] { "/callback", "/Account/Login", "/Account/Refresh", "/Account/SubdomainCallback" };
            app.MapWhen(c => !authPaths.Contains(c.Request.Path.Value),
                appM =>
                ...
                appM.Use(typeof(CustomOpenIdConnectAuthenticationMiddleware), appM, new OpenIdConnectAuthenticationOptions
                {
                    ...
                    Notifications = new OpenIdConnectAuthenticationNotifications
                    {
                        RedirectToIdentityProvider = async ctx =>
                        {
                            ...
                            if (ctx.Request.Path.Value == "/Account/Refresh")
